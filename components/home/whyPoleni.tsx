        ...
        >
          {reasons.map((reason) => (
            <motion.div
              ...
              className={`relative p-8 rounded-2xl border ${reason.border} ${reason.bg}
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-bold mb-1" style={{ color: "var(--text-primary)" }}>{reason.title}</h3>
                <p className="text-sm font-semibold mb-3" style={{ color: "var(--text-secondary)" }}>{reason.desc}</p>
                <p className="text-sm leading-relaxed" style={{ color: "var(--text-muted)" }}>{reason.detail}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>
