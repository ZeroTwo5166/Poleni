  ...
  return (
    <section className="relative py-32 px-6 overflow-hidden">
      <div
        ...
        style={{ background: "radial-gradient(ellipse at 50% 100%, rgba(99,102,241,0.05) 0%, transparent 60%)" }}
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          <p className="text-sm uppercase tracking-widest mb-10" style={{ color: "var(--text-muted)" }}>
            Trusted by
          </p>
          <motion.div
        ...
        >
          {testimonials.map((t) => (
            ...
            >
              <span className="text-4xl font-serif absolute top-4 right-5" style={{ color: "var(--text-primary)", opacity: 0.05 }}>
                &quot;
              </span>
        ...
        >
          <p className="text-sm mb-6" style={{ color: "var(--text-muted)" }}>Ready to grow your business?</p>
          <Link
            href="/contact"
