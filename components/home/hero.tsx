...
export default function Hero() {
  ...
  if (isDark) {
    ...
    return (
      ...
      >
        ...
        <motion.div style={{ opacity, y }} className="relative z-10 max-w-5xl mx-auto px-6 text-center py-32">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }}
            className="text-lg md:text-xl max-w-xl mx-auto mt-6 mb-4 leading-relaxed" style={{ color: "var(--text-secondary)" }}>
  ...
  return (
    ...
    >
      ...
      {/* Main content */}
      <motion.div
        style={{ opacity, y, zIndex: 3 }}
        className="relative max-w-5xl mx-auto px-6 text-center py-32"
      ...
      >
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8
                     border border-indigo-400/30 shadow-sm"
        ...
        >
          ...
          <Link
            ...
            className="px-8 py-4 rounded-xl font-semibold transition-all duration-300
                       ...
                       hover:bg-indigo-50/50 backdrop-blur-sm"
        ...
        >
          {stats.map((stat, i) => (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.55 + i * 0.08 }}
              className="flex flex-col items-center gap-1 p-4 rounded-xl border shadow-sm"
              style={{
                background:  "rgba(255,255,255,0.65)",
